...
pageLayout pageContent =
    div [ class "bg-white min-h-screen w-full flex flex-col" ]
        [ navbar
        , div [ class "flex-auto" ] [ pageContent ]
        , foot
        ]
...
mainNav : Html msg
mainNav =
    div [ class "backdrop-blur-md bg-opacity-50 from-black -mb-16 sticky top-0 z-10 mix-blend-difference" ]
        [ div [ class "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ]
            [ div [ class "h-16 flex items-center justify-between" ]
                [ {- Logo (lg+) -}
                  div [ class "hidden lg:flex-1 lg:flex lg:items-center" ]
                    [ a [ href <| Route.toString Route.Index ]
